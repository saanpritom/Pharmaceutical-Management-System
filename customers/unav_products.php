		...
		<div class="row">
			<div class="col-md-12">
				<?php
					...
					$query="SELECT mpo_id FROM mpo_customer_relation WHERE cus_id='$sm_id' and status='2'";
					$result=mysql_query($query,$dbs);
					while($row=mysql_fetch_array($result)){
						$mpo_id = $row['mpo_id'];
						$query2="SELECT ut_number, company_name FROM mpo_details WHERE mpo_id='$mpo_id'";
						$result2=mysql_query($query2,$dbs);
						while($row2=mysql_fetch_array($result2)){
							?>
							<p class="alert alert-danger"><strong><a href="company_unav_products.php?ut_num=<?php echo $row2['ut_number']; ?>"><?php echo $row2['company_name']; ?></a></strong></p><br>
							<?php
						}
					}
