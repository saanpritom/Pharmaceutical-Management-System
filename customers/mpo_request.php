					...
					<table class="table table-responsive table-stripped">
						...
						<tbody>
							...
							<?php
								...
								$query="SELECT mpo_id, status FROM mpo_customer_relation WHERE cus_id='$sm_id'";
								$result=mysql_query($query,$dbs);
								while($row=mysql_fetch_array($result)){
									$cus= $row['mpo_id'];
									while($row['status']==1){
										$query="SELECT first_name,last_name FROM mpo_details WHERE mpo_id='$cus'";
										$result=mysql_query($query,$dbs);
										while($row=mysql_fetch_array($result)){
											echo '<tr>';
											echo '<td>';
											?>
												<img src="../mpo/database_images/mpo_images/<?php echo $cus; ?>.jpg" width="70px" height="70px">
											<?php
											echo '</td>';
											echo '<td>';
											?>
											<a href="mpo_details.php?cs_id=<?php echo $cus; ?>"><?php echo $row['first_name']; ?></a>
											<?php
											echo '</td>';
											echo '<td>';
											?>
											<a href="mpo_details.php?cs_id=<?php echo $cus; ?>"><?php echo $row['last_name']; ?></a>
											<?php
											echo '</td>';
											echo '<td>';
											?>
											<a href="add_new_mpo.php?cs_id=<?php echo $cus; ?>">Yes</a>
											<?php
											echo '</td>';
											echo '<td>';
											?>
											<a href="delete_mpo.php?cs_id=<?php echo $cus; ?>">No</a>
											<?php
											echo '</td>';
											echo '</tr>';
										}
