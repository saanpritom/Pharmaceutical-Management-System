			...
			<div class="col-md-12">
				<div class="box-body">
					...
					$query="SELECT product_description.product_id, product_description.business_name, product_description.scientific_name FROM product_description INNER JOIN product_availability
							...
							(product_availability.availability='0' and company_product.ut_num='$ut_number') and product_description.product_type='Injection'";
		...
		<div class="row">
			<div class="col-md-12">
				<div class="box-body">
					...
					$query="SELECT product_description.product_id, product_description.business_name, product_description.scientific_name FROM product_description INNER JOIN product_availability
							ON product_description.product_id=product_availability.product_id INNER JOIN company_product ON product_description.product_id=company_product.product_id WHERE 
							(product_availability.availability='0' and company_product.ut_num='$ut_number') and product_description.product_type='Syrup'";
		...
		<div class="row">
			<div class="col-md-12">
				<div class="box-body">
					...
					$query="SELECT product_description.product_id, product_description.business_name, product_description.scientific_name FROM product_description INNER JOIN product_availability
							ON product_description.product_id=product_availability.product_id INNER JOIN company_product ON product_description.product_id=company_product.product_id WHERE 
							(product_availability.availability='0' and company_product.ut_num='$ut_number') and product_description.product_type='Tablet'";
		...
		<div class="row">
			<div class="col-md-12">
				<div class="box-body">
					...
					$query="SELECT product_description.product_id, product_description.business_name, product_description.scientific_name FROM product_description INNER JOIN product_availability
							ON product_description.product_id=product_availability.product_id INNER JOIN company_product ON product_description.product_id=company_product.product_id WHERE 
							(product_availability.availability='0' and company_product.ut_num='$ut_number') and product_description.product_type='Capsule'";
