							...
							<?php
								...
								while($row=mysql_fetch_array($result)){
									...
									$query1="SELECT bill_status.order_id, bill_status.total_bill, mpo_details.company_name FROM bill_status INNER JOIN order_relation ON bill_status.order_id=order_relation.order_id
												INNER JOIN mpo_details ON order_relation.mpo_id=mpo_details.mpo_id WHERE bill_status.pay_status='1' and mpo_details.mpo_id='$mpo_id'";
									...
									while($row1=mysql_fetch_array($result1)){
										...
										<tr>
											...
											<td style="background-color:green; color:white;">Paid</td>
										</tr>
										<?php
										}
