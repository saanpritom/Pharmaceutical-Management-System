					...
					<table class="table table-responsive table-stripped">
						...
						<tbody>
							<?php 
								...
								$query="SELECT sm_id, first_name, last_name, com_name, tel_numb FROM sm_details WHERE ut_num=
											(SELECT ut_number FROM mpo_details WHERE mpo_id=(SELECT mpo_id FROM mpo_customer_relation WHERE cus_id='$sm_id' and status='2'))";
								...
								while($row=mysql_fetch_array($result)){
									?>
										<tr>
											<td>
												<img src="../sales_manager/images/<?php echo $row['sm_id']; ?>.jpg" width="70px" height="70px">
											</td>
											<td>
