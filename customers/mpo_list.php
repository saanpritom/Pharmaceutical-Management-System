		...
		<div class="row">
			<div class="col-md-12">
				<div class="col-md-4">
					...
					<form action="add_mpo.php" method="post">
					
						<div class="form-group has-success has-feedback">
							<label class="control-label" for="inputGroupSuccess1">Search MPO's By Username To add them</label>
							<div class="input-group">
								<span class="input-group-addon">@</span>
									<input type="text" class="form-control" name="mpo" id="inputGroupSuccess1" aria-describedby="inputGroupSuccess1Status">
								</div>
					...
					<a href="mpo_request.php" type="button" class="btn btn-primary">New MPO Request</a>
			...
			<div class="col-md-12">
				<div class="table">
					<table class="table table-responsive table-stripped">
						...
						<tbody>
							<?php
								$query="SELECT mpo_id FROM mpo_customer_relation WHERE status='2' and cus_id='$sm_id'";
								$result=mysql_query($query,$dbs);
								while($row=mysql_fetch_array($result)){
									$mpo_id= $row['mpo_id'];
								}
								
								$query="SELECT first_name, last_name, city, tel_number FROM mpo_details WHERE mpo_id='$mpo_id'";
								$result=mysql_query($query,$dbs);
								while($row=mysql_fetch_array($result)){
									?>
									<tr>
										<td>
											<img src="../mpo/database_images/mpo_images/<?php echo $mpo_id; ?>.jpg" width="70px" height="70px">
										</td>
										<td>
											<a href="mpo_details.php?cs_id=<?php echo $mpo_id; ?>"><?php echo $row['first_name']; ?></a>
										</td>
										<td>
											<a href="mpo_details.php?cs_id=<?php echo $mpo_id; ?>"><?php echo $row['last_name']; ?></a>
										</td>
										<td>
											<?php echo $row['city']; ?>
										</td>
