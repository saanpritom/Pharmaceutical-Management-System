            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">
				<?php
					...
					$query="SELECT COUNT(mpo_id) AS t_id FROM mpo_customer_relation WHERE cus_id='$sm_id' and status='2'";
					$result=mysql_query($query,$dbs);
					while($row=mysql_fetch_array($result)){
						echo $row['t_id'];
					}
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">
				<?php
					...
					$query="SELECT COUNT(order_id) AS o_id FROM order_relation WHERE cus_id='$sm_id'";
					$result=mysql_query($query,$dbs);
					while($row=mysql_fetch_array($result)){
						echo $row['o_id'];
					}
          ...
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">
				...
				$query="SELECT SUM(bill_status.total_bill) AS t_bill FROM bill_status INNER JOIN order_relation ON bill_status.order_id=order_relation.order_id WHERE order_relation.cus_id='$sm_id'";
				$result=mysql_query($query,$dbs);
				while($row=mysql_fetch_array($result)){
					echo $row['t_bill'];
				}
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">
				<?php
					...
					$query="SELECT SUM(bill_status.total_bill) AS t_bill FROM bill_status INNER JOIN order_relation ON bill_status.order_id=order_relation.order_id WHERE order_relation.cus_id='$sm_id' and bill_status.pay_status='0'";
					$result=mysql_query($query,$dbs);
					while($row=mysql_fetch_array($result)){
						if($row['t_bill']!=null){
							echo $row['t_bill'];
		...
		<hr>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <div class="row">
                <?php
					$query="SELECT mpo_customer_relation.mpo_id, COUNT(order_relation.order_id) AS o_id FROM mpo_customer_relation
							INNER JOIN order_relation ON mpo_customer_relation.mpo_id=order_relation.mpo_id
							WHERE mpo_customer_relation.status='2' and mpo_customer_relation.cus_id='$sm_id' GROUP BY mpo_customer_relation.mpo_id ORDER BY o_id DESC";
					$result=mysql_query($query,$dbs);
					while($row=mysql_fetch_array($result)){
						$cus_id = $row['mpo_id'];
						break;
					...
					$query="SELECT mpo_details.first_name, mpo_details.last_name, COUNT(order_relation.order_id) AS t_id FROM mpo_details INNER JOIN order_relation ON
							mpo_details.mpo_id=order_relation.mpo_id WHERE mpo_details.mpo_id='$cus_id'";
					$result=mysql_query($query,$dbs);
					while($row=mysql_fetch_array($result)){
						?>
						<div class="col-md-6">
							<img src="../mpo/database_images/mpo_images/<?php echo $cus_id; ?>.jpg" width="50%" height="auto">
						</div>
						<div class="col-md-6">
							<strong>Name: </strong><a href="mpo_details.php?cs_id=<?php echo $cus_id; ?>"><?php echo $row['first_name']; echo '  '; echo $row['last_name']; ?></a><br>
		  ...
		  <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Lowest MPO</h3>
            ...
            <div class="box-body">
                ...
                <?php
					$query="SELECT mpo_customer_relation.mpo_id, COUNT(order_relation.order_id) AS o_id FROM mpo_customer_relation
							INNER JOIN order_relation ON mpo_customer_relation.mpo_id=order_relation.mpo_id
							WHERE mpo_customer_relation.status='2' and mpo_customer_relation.cus_id='$sm_id' GROUP BY mpo_customer_relation.mpo_id ORDER BY o_id ASC";
					$result=mysql_query($query,$dbs);
					while($row=mysql_fetch_array($result)){
						$cus_id = $row['mpo_id'];
						break;
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">MPO with most Dew</h3>
              ...
              <div class="row">
                <?php
					...
					$query="SELECT order_relation.mpo_id, COUNT(order_relation.mpo_id) AS m_id FROM order_relation INNER JOIN bill_status ON order_relation.order_id=bill_status.order_id 
							WHERE bill_status.pay_status='0' and order_relation.cus_id='$sm_id' GROUP BY order_relation.mpo_id ORDER BY m_id DESC";
					$result=mysql_query($query,$dbs);
					while($row=mysql_fetch_array($result)){
						$m_id = $row['mpo_id'];
						break;
					...
					while($row=mysql_fetch_array($result)){
						...
						<div class="col-md-6">
							<strong>Name: </strong><a href="mpo_details.php?cs_id=<?php echo $m_id; ?>"><?php echo $row['first_name']; echo '  '; echo $row['last_name']; ?></a><br>
		  ...
		  <div class="box">
            ...
            <div class="box-body">
              <div class="row">
                <?php
					$query="SELECT mpo_id, COUNT(mpo_id) AS m_id FROM order_relation WHERE cus_id='$sm_id' GROUP BY mpo_id ORDER BY m_id ASC";
					$result=mysql_query($query,$dbs);
					while($row=mysql_fetch_array($result)){
						$m_id = $row['mpo_id'];
						break;
              ...
              <div class="row">
                <?php
					$query="SELECT order_relation.product_id, COUNT(order_relation.product_id) AS p_id FROM order_relation
							WHERE order_relation.cus_id='$sm_id' GROUP BY order_relation.product_id ORDER BY p_id DESC";
					$result=mysql_query($query,$dbs);
					while($row=mysql_fetch_array($result)){
						$p_id = $row['product_id'];
						break;
          ...
          <div class="box">
            ...
            <div class="box-body">
              <div class="row">
                <?php
					$query="SELECT order_relation.product_id, COUNT(order_relation.product_id) AS p_id FROM order_relation
							WHERE order_relation.cus_id='$sm_id' GROUP BY order_relation.product_id ORDER BY p_id ASC";
					$result=mysql_query($query,$dbs);
					while($row=mysql_fetch_array($result)){
						$p_id = $row['product_id'];
						break;
