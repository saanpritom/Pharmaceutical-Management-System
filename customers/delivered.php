...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
						...
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								<div class="modal-header">
									...
									<h4 class="modal-title" id="myModalLabel">Provide the order number of the delivery</h4>
								</div>
		...
		<hr>
		<h3>Your previous delivered products</h3><br>
		<div class="row">
			<div class="col-md-12">
				<div class="table">
					<table class="table table-responsive table-stripped">
						...
						<tbody>
							<?php
								$count=1;
								$query="SELECT product_description.business_name, product_description.scientific_name, product_description.product_type, order_relation.mpo_id, order_relation.order_id, 
										...
										INNER JOIN order_status ON order_relation.order_id=order_status.order_id WHERE order_relation.cus_id='$sm_id' and order_status.status='3'";
								$result=mysql_query($query,$dbs);
								while($row=mysql_fetch_array($result)){
									?>
									<tr>
										...
										<td><?php
												$mpo_id=$row['mpo_id'];
												$query1="SELECT company_name FROM mpo_details WHERE mpo_id='$mpo_id'";
										...
										<td style="background-color:green; color:white;">Delivered</td>
									</tr>
									<?php
									$count++;
								}
