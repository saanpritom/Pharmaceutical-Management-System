		...
		<div class="row">
			<div class="col-md-12">
				<?php
					...
					$cs_id = $_GET['cs_id'];
					$query="SELECT first_name, last_name, company_name, company_address, city, state, zip, country, tel_number, gender, designation FROM mpo_details WHERE mpo_id='$cs_id'";
					$result=mysql_query($query, $dbs);
					while($row=mysql_fetch_array($result)){
						?>
						<div class="jumbotron" align="center">
							<img src="../mpo/database_images/mpo_images/<?php echo $cs_id; ?>.jpg" width="40%" height="auto"><br>
