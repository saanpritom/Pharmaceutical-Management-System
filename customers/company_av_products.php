...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?php
			$ut_number = $_GET['ut_num'];
			
			$query="SELECT company_name FROM mpo_details WHERE ut_number='$ut_number'";
			$result=mysql_query($query,$dbs);
			while($row=mysql_fetch_array($result)){
		...
		<div class="row">
			<div class="col-md-12">
				<div class="box-body">
					...
					$query="SELECT product_description.product_id, product_description.business_name, product_description.scientific_name FROM product_description INNER JOIN product_availability
							ON product_description.product_id=product_availability.product_id INNER JOIN company_product ON product_description.product_id=company_product.product_id WHERE 
							(product_availability.availability='1' and company_product.ut_num='$ut_number') and product_description.product_type='Injection'";
					...
					while($row=mysql_fetch_array($result)){
						...
						<tr>
							<td class="success">
													...
													<td class="success">
														<img src="../sales_manager/database_images/product_images/<?php echo $row['product_id']; ?>.jpg" width="60px" height="60px">
													</td>
													<td class="success">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="box-body">
					...
					$query="SELECT product_description.product_id, product_description.business_name, product_description.scientific_name FROM product_description INNER JOIN product_availability
							ON product_description.product_id=product_availability.product_id INNER JOIN company_product ON product_description.product_id=company_product.product_id WHERE 
							(product_availability.availability='1' and company_product.ut_num='$ut_number') and product_description.product_type='Syrup'";
		...
		<div class="row">
			<div class="col-md-12">
				<div class="box-body">
					...
					$query="SELECT product_description.product_id, product_description.business_name, product_description.scientific_name FROM product_description INNER JOIN product_availability
							ON product_description.product_id=product_availability.product_id INNER JOIN company_product ON product_description.product_id=company_product.product_id WHERE 
							(product_availability.availability='1' and company_product.ut_num='$ut_number') and product_description.product_type='Tablet'";
		...
		<div class="row">
			<div class="col-md-12">
				<div class="box-body">
					...
					$query="SELECT product_description.product_id, product_description.business_name, product_description.scientific_name FROM product_description INNER JOIN product_availability
							ON product_description.product_id=product_availability.product_id INNER JOIN company_product ON product_description.product_id=company_product.product_id WHERE 
							(product_availability.availability='1' and company_product.ut_num='$ut_number') and product_description.product_type='Capsule'";
