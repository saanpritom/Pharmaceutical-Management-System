				...
				<div class="col-md-4">
					<form action="add_new_customer.php" method="post">
						...
						<div class="form-group has-success has-feedback">
							<label class="control-label" for="inputGroupSuccess1">Search Customer By Username To add them</label>
							<div class="input-group">
								<span class="input-group-addon">@</span>
									<input type="text" class="form-control" name="customer" id="inputGroupSuccess1" aria-describedby="inputGroupSuccess1Status">
								</div>
					...
					<a href="customer_request.php" type="button" class="btn btn-primary">New Customer Request</a><br>
				</div>
			</div>
		</div><br>
		<div class="row">
			<div class="col-md-12">
				<div class="table">
					<table class="table table-responsive table-stripped">
						...
						<tbody>
							<?php
								$query="SELECT cus_id FROM mpo_customer_relation WHERE status='2' and mpo_id='$sm_id'";
								$result=mysql_query($query,$dbs);
								while($row=mysql_fetch_array($result)){
									$cus_id= $row['cus_id'];
								}
								
								$query="SELECT first_name, last_name, city, tel_number FROM customer_details WHERE cus_id='$cus_id'";
								$result=mysql_query($query,$dbs);
								while($row=mysql_fetch_array($result)){
									?>
									<tr>
										<td>
											<img src="../customers/database_images/mpo_images/<?php echo $cus_id; ?>.jpg" width="70px" height="70px">
										</td>
										<td>
											<a href="customer_details.php?cs_id=<?php echo $cus_id; ?>"><?php echo $row['first_name']; ?></a>
										</td>
										<td>
											<a href="customer_details.php?cs_id=<?php echo $cus_id; ?>"><?php echo $row['last_name']; ?></a>
										</td>
										<td>
											<?php echo $row['city']; ?>
										</td>
