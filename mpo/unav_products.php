          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
					<?php
						$query = "SELECT designation, com_name FROM mpo_details WHERE mpo_id='$sm_id'";
						$result=mysql_query($query,$dbs);
						while($row=mysql_fetch_array($result)){
    ...
    <section class="content">
							...
							<div class="table">
								<table class="table table-responsive table-striped table-hover">
									...
									<tbody>
										<?php
											$count=1;
											$query="SELECT product_description.product_id, product_description.business_name, product_description.scientific_name, 
													product_description.batch_number FROM product_description INNER JOIN product_availability ON product_description.product_id=product_availability.product_id
													WHERE product_description.product_type='Injection' and product_availability.availability='0'";
		...
		<div class="row">
			<div class="col-md-12">
				<div class="box">
					<div class="box-header with-border">
						<h3 class="box-title"><strong>Syrups</strong></h3>
						<div class="box-tools pull-right">
						<button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
						</button>
						<button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
								...
								<table class="table table-responsive table-striped table-hover">
									...
									<tbody>
										<?php
											...
											$query="SELECT product_description.product_id, product_description.business_name, product_description.scientific_name, 
													product_description.batch_number FROM product_description INNER JOIN product_availability ON product_description.product_id=product_availability.product_id
													WHERE product_description.product_type='Syrup' and product_availability.availability='0'";
								...
								<table class="table table-responsive table-striped table-hover">
									...
									<tbody>
										<?php
											...
											$query="SELECT product_description.product_id, product_description.business_name, product_description.scientific_name, 
													product_description.batch_number FROM product_description INNER JOIN product_availability ON product_description.product_id=product_availability.product_id
													WHERE product_description.product_type='Tablet' and product_availability.availability='0'";
								...
								<table class="table table-responsive table-striped table-hover">
									...
									<tbody>
										<?php
											...
											$query="SELECT product_description.product_id, product_description.business_name, product_description.scientific_name, 
													product_description.batch_number FROM product_description INNER JOIN product_availability ON product_description.product_id=product_availability.product_id
													WHERE product_description.product_type='Capsule' and product_availability.availability='0'";
