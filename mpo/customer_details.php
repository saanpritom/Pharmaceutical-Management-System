		...
		<div class="row">
			<div class="col-md-12">
				<?php
					...
					$cs_id = $_GET['cs_id'];
					$query="SELECT first_name, last_name, company_name, company_address, city, state, zip, country, tel_number, gender, designation FROM customer_details WHERE cus_id='$cs_id'";
					$result=mysql_query($query, $dbs);
					while($row=mysql_fetch_array($result)){
						?>
						<div class="jumbotron" align="center">
							<img src="../customers/database_images/mpo_images/<?php echo $cs_id; ?>.jpg" width="40%" height="auto"><br>
							<strong>Name  </strong><?php echo $row['first_name']; echo '  '; echo $row['last_name']; ?><br>
							<strong>Organization Name  </strong><?php echo $row['company_name']; ?><br>
							<strong>Organization Address  </strong><?php echo $row['company_address']; ?><br>
							<strong>City  </strong><?php echo $row['city']; ?><br>
							<strong>State  </strong><?php echo $row['state']; ?><br>
							<strong>Zip Code  </strong><?php echo $row['zip']; ?><br>
							<strong>Country  </strong><?php echo $row['country']; ?><br>
							<strong>Telephone  </strong><?php echo $row['tel_number']; ?><br>
