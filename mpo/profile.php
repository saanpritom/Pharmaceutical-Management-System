  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
		...
		<li><a href="statics.php"><i class="fa fa-bar-chart"></i> <span>Statistics</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
			...
			<div class="box-body no-padding">
				...
				<div class="col-md-12">
					<div class="row">
						...
						<div class="col-md-6">
							<img src="database_images/mpo_images/<?php echo $sm_id ?>.jpg" width="20%" height="auto" alt="user_image" class="img-thumbnail">
						</div>
					</div><br>
					<div class="row">
						<div class="col-md-6">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<p><strong><?php echo $webs; ?></strong></p>
						</div>
					</div>
					<hr>
					<?php
						$query = "SELECT username, email FROM mpo_login WHERE mpo_id='$sm_id'";
						$result=mysql_query($query,$dbs);
						while($row=mysql_fetch_array($result)){
