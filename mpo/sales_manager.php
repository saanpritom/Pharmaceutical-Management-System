  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Sales Manager of the Company</li>
      </ol>
    </section>
	<!-- Main content -->
			...
			<div class="col-md-12">
				<div class="col-md-4">
					...
					<?php
						...
						$query="SELECT ut_number FROM mpo_details WHERE mpo_id='$sm_id'";
						$result=mysql_query($query,$dbs);
						while($row=mysql_fetch_array($result)){
							$ut_num = $row['ut_number'];
						}
					
						$query="SELECT sm_id, first_name, last_name, com_name, com_address, city, state, zip, country, tel_numb, designation, webs FROM sm_details WHERE ut_num='$ut_num'";
						$result=mysql_query($query,$dbs);
						while($row=mysql_fetch_array($result)){
							?>
				...
				<div class="col-md-12">
					<div class="row">
						...
						<div class="col-md-6">
							<img src="../sales_manager/images/<?php echo $row['sm_id']; ?>.jpg" width="70%" height="auto" alt="user_image" class="img-thumbnail">
						</div>
					</div><br>
					<div class="row">
						<div class="col-md-6">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<p><strong><?php echo $row['com_name']; ?></strong></p>
						</div>
					</div>
					<div class="row">
						<div class="col-md-6">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<p><strong><?php echo $row['com_address']; ?></strong></p>
						</div>
					</div>
					<div class="row">
						<div class="col-md-6">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<p><strong><?php echo $row['tel_numb']; ?></strong></p>
						</div>
					</div>
					<div class="row">
						<div class="col-md-6">
						...
						<div class="col-md-6">
							<p><strong><?php echo $row['webs']; ?></strong></p>
						</div>
					</div>
					<hr>
					<?php
