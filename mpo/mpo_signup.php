        ...
        <div class="col-lg-12">
            ...
            <div class="col-lg-8">
                <div class="content">
                    <div class="row">
                        <div class="heading">
                            <h2>Medical Promotion Officer Sign Up.  <span class="glyphicon glyphicon-hand-down" aria-hidden="true"></span></h2> 
                        </div>
                    </div><br>
                    <div class="row">
                        <div class="panel">
                            ...
                            <div class="panel-body" id="signup_panel_body">
                                <form name="signup_form" action="mpo_back_signup.php" method="POST" enctype="multipart/form-data">
                                <div class="table">
                                    <table class="table table-responsive">
                                        <thead></thead>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                   <div class="form-group required">
                                                        ...
                                                        <input name="ut_number" type="text" class="form-control" id="exampleInputUtrnumber" placeholder="Provided by your sales manager">
