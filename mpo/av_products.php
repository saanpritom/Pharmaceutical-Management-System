									...
									<tbody>
										<?php
											...
											$query="SELECT product_description.product_id, product_description.business_name, product_description.scientific_name, 
													...
													WHERE product_description.product_type='Injection' and product_availability.availability='1'";
								...
								<table class="table table-responsive table-striped table-hover">
									...
									<tbody>
										<?php
											...
											$query="SELECT product_description.product_id, product_description.business_name, product_description.scientific_name, 
													product_description.batch_number FROM product_description INNER JOIN product_availability ON product_description.product_id=product_availability.product_id
													WHERE product_description.product_type='Syrup' and product_availability.availability='1'";
								...
								<table class="table table-responsive table-striped table-hover">
									...
									<tbody>
										<?php
											...
											$query="SELECT product_description.product_id, product_description.business_name, product_description.scientific_name, 
													product_description.batch_number FROM product_description INNER JOIN product_availability ON product_description.product_id=product_availability.product_id
													WHERE product_description.product_type='Tablet' and product_availability.availability='1'";
								...
								<table class="table table-responsive table-striped table-hover">
									...
									<tbody>
										<?php
											...
											$query="SELECT product_description.product_id, product_description.business_name, product_description.scientific_name, 
													product_description.batch_number FROM product_description INNER JOIN product_availability ON product_description.product_id=product_availability.product_id
													WHERE product_description.product_type='Capsule' and product_availability.availability='1'";
