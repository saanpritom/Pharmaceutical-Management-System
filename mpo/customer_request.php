					...
					<table class="table table-responsive table-stripped">
						...
						<tbody>
							...
							<?php
								...
								$query="SELECT cus_id, status FROM mpo_customer_relation WHERE mpo_id='$sm_id'";
								$result=mysql_query($query,$dbs);
								while($row=mysql_fetch_array($result)){
									$cus= $row['cus_id'];
									while($row['status']==1){
										$query="SELECT first_name,last_name FROM customer_details WHERE cus_id='$cus'";
										$result=mysql_query($query,$dbs);
										while($row=mysql_fetch_array($result)){
											echo '<tr>';
											echo '<td>';
											?>
												<img src="../customers/database_images/mpo_images/<?php echo $cus; ?>.jpg" width="70px" height="70px">
											<?php
											echo '</td>';
											echo '<td>';
											?>
											<a href="customer_details.php?cs_id=<?php echo $cus; ?>"><?php echo $row['first_name']; ?></a>
											<?php
											echo '</td>';
											echo '<td>';
											?>
											<a href="customer_details.php?cs_id=<?php echo $cus; ?>"><?php echo $row['last_name']; ?></a>
											<?php
											echo '</td>';
											echo '<td>';
											?>
											<a href="add_customer.php?cs_id=<?php echo $cus; ?>">Yes</a>
											<?php
											echo '</td>';
											echo '<td>';
											?>
											<a href="delete_customer.php?cs_id=<?php echo $cus; ?>">No</a>
											<?php
											echo '</td>';
											echo '</tr>';
										}
