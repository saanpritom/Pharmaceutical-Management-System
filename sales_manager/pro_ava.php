						...
						<div class="col-md-12">
							<div class="box">
								<div class="box-header with-border">
									<h3 class="box-title"><strong>Product Description</strong></h3>
								...
								<div class="box-body">
									<div class="row col-md-12">
										<?php
											...
											while($row=mysql_fetch_array($result)){
												?>
													<img src="database_images/product_images/<?php echo $pro_id; ?>.jpg" width="360px" height="230px"><br><br><br>
													...
													<strong>Price     </strong><?php echo $row['price']; ?><br><br>
												<?php
											}
										?>
										<a href="delete_product.php?pro_id=<?php echo $pro_id; ?>" type="button" class="btn btn-danger">Delete Product</a>
										<hr>
										<form name="pro_ava" action="change_availability.php?pro_id=<?php echo $pro_id; ?>" method="POST" enctype="multipart/form-data">
											<div class="col-md-6">
											...
											<div class="col-md-6">
												<div class="alert alert-danger" role="alert">
													<div class="radio">
														<label><input type="radio" name="optradio" value="0">Make it Unaialable</label>
													</div>
												</div>
											</div>
