													...
													<?php
														...
														while($row=mysql_fetch_array($result)){
															...
															<tr>
																...
																<td><?php
																$m_id = $row['mpo_id'];
																$query1="SELECT SUM(order_id) AS t_order FROM order_relation WHERE mpo_id='$m_id'";
																...
																?></td>
																<td><a href="mpo_order_details.php?mpo_id=<?php echo $row['mpo_id']; ?>" type="button" class="btn btn-primary">See Orders</a></td>
															</tr>
															<?php
															$count++;
														}
