				...
				<div class="col-md-4">
					<?php
						...
						$status = $_POST['optradio'];
							...
							$query="UPDATE product_availability SET availability='$status' WHERE product_id='$pro_id'";
							mysql_query($query,$dbs);
					?>
				</div>
				<div class="alert alert-success" role="alert">Updated Status Successfully. <a href="all_products.php">Go Back</a></div>
			</div>
		</div>
	</section>
  </div>
