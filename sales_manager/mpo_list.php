													...
													<?php
														...
														while($row=mysql_fetch_array($result)){
															...
															<tr>
																...
																<td><a href="mpo_details.php?mpo_id=<?php echo $row['mpo_id']; ?>"><?php echo $row['first_name']; ?> </a></td>
																<td><a href="mpo_details.php?mpo_id=<?php echo $row['mpo_id']; ?>"><?php echo $row['last_name']; ?> </a></td>
