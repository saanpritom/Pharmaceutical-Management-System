													...
													<?php
														...
														while($row=mysql_fetch_array($result)){
															...
															<tr>
																...
																<td><?php
																$m_id = $row['mpo_id'];
																$query1="SELECT SUM(order_relation.order_id) as t_order FROM order_relation INNER JOIN order_status ON order_relation.order_id=order_status.order_id WHERE order_relation.mpo_id='$m_id' and order_status.status='3'";
																...
																?></td>
																<td><a href="mpo_delivered_details.php?mpo_id=<?php echo $row['mpo_id']; ?>" type="button" class="btn btn-success">See Orders</a></td>
															</tr>
															<?php
															$count++;
														}
