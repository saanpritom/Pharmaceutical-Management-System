			...
			<div class="col-md-12">
				<div class="col-md-4">
					<?php
						...
						$query="DELETE FROM product_description WHERE product_id='$pro_id'";
						if(mysql_query($query,$dbs)){
							$query="DELETE FROM product_availability WHERE product_id='$pro_id'";
							if(mysql_query($query,$dbs)){
								$query="DELETE FROM company_product WHERE product_id='$pro_id'";
								if(mysql_query($query,$dbs)){
									$file = "database_images/product_images/$pro_id.jpg";
									if(unlink($file)){
										?>
											<div class="alert alert-success" role="alert">
													Product Successfully Deleted. <a href="all_products.php">Go back</a>
												</div>
										<?php
									}
								}
							...
							<div class="alert alert-danger" role="alert">
													Something went wrong please try again. <a href="all_products.php">Go back</a>
												</div>
						<?php
						}
